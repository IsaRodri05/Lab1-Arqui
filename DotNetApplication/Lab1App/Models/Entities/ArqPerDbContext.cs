...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,8888;Database=arq_per_db;User Id=sa;Password=Lab12345;Encrypt=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => new { e.IdProf, e.CcPer }).HasName("PK__estudios__FB3F71A6DE2CF141");
        ...
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666D731D2A28");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83F5D048C9F");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D655F0A227D");
